...
export class ConfigService {
    ...
    private readonly bapSearchWebhookUri;
    ...
    constructor() {
        ...
        this.bapSearchWebhookUri = process.env.BAP_SEARCH_WEBHOOK_URI || '';
    ...
    getBapSearchWebhookUri(): string {
        if(this.bapSearchWebhookUri === '' || this.bapSearchWebhookUri === undefined) {
        return this.bapWebhookUri;
            
        }
        return this.bapSearchWebhookUri;
    };
}
